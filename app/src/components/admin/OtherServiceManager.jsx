...
export default function OtherServiceManager() {
  ...
  async function handleDelete(id) {
    ...
    await fetch(`/api/other-services?id=${id}`, { method: 'DELETE' });
    showToast('✓ Đã xóa!');
    fetchData();
  }
    ...
    <>
      <div className="admin-section">
        <div className="admin-section__header">
          <h2 className="admin-section__title">Quản lý Dịch vụ khác</h2>
        ...
        <div className="modal-overlay" onClick={resetForm}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal__header">
              <h3 className="modal__title">{editItem ? '✏️ Sửa' : '+ Thêm dịch vụ khác'}</h3>
            ...
            <form onSubmit={handleSubmit} className="admin-form">
              <div className="form-group">
                <label>Tên *</label>
                <input type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="VD: Vé máy bay" required />
              </div>
